...
def build_ddg_with_sparse(input_dir, output_dir, matrix_size=90):
    ...
    if sparse_matrices:
        ...
        output_path = os.path.join(output_dir, "ddg_sparse.npz")
        ...
        np.save(os.path.join(output_dir, "ddg_filenames_sparse.npy"), filenames)
        
        print(f"Saved {len(sparse_matrices)} ddg matrices to {output_path}")
    else:
...
if __name__ == "__main__":
    build_ddg_with_sparse(
        input_dir="../../dataset/ddg/ddg-dot-txt-files/",
        output_dir="../../dataset/ddg/",
    )
    print(unpack_sparse_matrices(sp.load_npz("../../dataset/ddg/ddg_sparse.npz"), 90))
